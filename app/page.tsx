...
export const metadata: Metadata = {
  title: 'Chennai Rent Prices & Owner-Direct Homes | Chennai.rent',
  description:
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <Container className="mt-20">
        ...
        {listings.length ? (
          ...
          <EmptyState
            ...
            body="Chennai.rent is owner-direct only. Be the first owner to list a home — it takes two minutes and costs nothing."
      ...
      {/* --------------------------------------------------- More product */}
      <Container className="mt-20">
        <SectionHeader eyebrow="More ways to use Chennai.rent" title="Beyond the listings" />
