...
export const metadata: Metadata = {
  title: 'How Chennai.rent works',
  description:
    'How Chennai.rent collects rent data, what we publish, what we refuse to estimate, and how we handle your privacy.',
...
const PRINCIPLES = [
  ...
  },
  {
    ...
    body: 'Chennai.rent charges no brokerage and lists no broker inventory. Accounts posting like agencies are flagged automatically and reviewed.',
  },
  {
  ...
  return (
    <Container className="py-10 lg:py-16">
      ...
      <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted">
        Chennai.rent exists because nobody can tell you what rent should cost in Chennai. Portals
